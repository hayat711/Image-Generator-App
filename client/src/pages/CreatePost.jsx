...
const CreatePost = () => {
      ...
      const generateImage = async () => {
            if (form.prompt) {
                  try {
                        ...
                        console.log('here is data from backend 👉' ,data);
      ...
      return (
            <section className='max-w-7xl mx-auto'>
                  <div>
                        <div className='font-extrabold text-[#222328] text-[32px]'>Create</div>
                        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
                              Create through a collection of imaginative and visually stunning images through DALL-E AI
